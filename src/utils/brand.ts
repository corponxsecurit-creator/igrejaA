...
export const brands: Record<string, BrandConfig> = {
  ...
  universal: {
    ...
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/IURD_dove.svg/512px-IURD_dove.svg.png',
  ...
  beityaacov: {
    ...
    logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Star_of_David_gold.svg/512px-Star_of_David_gold.svg.png',
